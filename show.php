...
<div class="question-box-picker">
    ...
    <li class="hexagon hexagon-blue" onclick="Main.pickQuestion(this)">
    ...
    <li class="hexagon hexagon-yellow" onclick="Main.pickQuestion(this)">
        <div class="hexagon-inner">
    ...
    <li class="hexagon hexagon-red" onclick="Main.pickQuestion(this)">
        <div class="hexagon-inner">
